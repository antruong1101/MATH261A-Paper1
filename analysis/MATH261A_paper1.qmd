...
Since the `OFFENSE_TIME` is cyclical, it cannot be modeled with a simple linear regression model. The linear nature of the simple regression model could not account for the "wrap-around" from 11 p.m. to 12 a.m. Because of this cyclical nature, many of the assumptions for using simple linear regression cannot be used such as linearity, independence, normality, and equal variance.
